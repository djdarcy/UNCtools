...
setup(
    ...
    url='https://github.com/yourusername/unctools',  # Replace with your repo URL
    ...
    extras_require={
        'windows': [
            'pywin32',  # For advanced Windows functionality
        ],
        'dev': [
            'pytest>=6.0.0',
            'pytest-cov>=2.10.0',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/yourusername/unctools/issues',  # Replace with your repo
        'Source': 'https://github.com/yourusername/unctools',  # Replace with your repo
    },
)
